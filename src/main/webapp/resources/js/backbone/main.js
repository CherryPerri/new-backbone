var RequireJSUtils = function() {
    ...
    // config animal module lib start
    var animalModuleLib = "animalModuleLib";
    var animalModuleLibPath = "modules/animal/animal-module";
    requireJSPath[animalModuleLib] = animalModuleLibPath;
    // config animal module lib end
...
//                urlArgs : "bust=" + (new Date()).getTime(),
        ...
        // animal module start
        loadAnimalModuleTemplate : function(tplName, callback) {
            this.loadModuleTemplate("animal", tplName, callback);
        },
        loadListAnimalTemplate : function(callback) {
            this.loadAnimalModuleTemplate("list-animal.htm", callback);
        },
        loadAnimalModule : function(callback) {
            require([animalModuleLib], callback);
        },
    };
}();
