...
//            });
        ...
        showDialogDeleteConfirm : function(username, cancelCallback, yesCallback) {
            ...
            msg += "<input type='password' class='form-control' id='txtPasswordConfirm' style='width: 180px;'/>";
...
//                      className: "btn-primary",
      ...
      showCustomDialog : function(title, htmlContent, successButton, dangerButton, mainButton, isCloseButton) {
          var buttons = {};
...
//                   className: "btn-primary",
      ...
      showDialogExport : function(title, htmlContent, okCallback, cancelCallback) {
          bootbox.dialog({
            message : htmlContent,
            title : title,
            closeButton: false,
