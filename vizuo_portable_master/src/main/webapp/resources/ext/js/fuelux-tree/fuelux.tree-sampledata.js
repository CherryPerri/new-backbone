...
//var tree_data = {
//	'hcm' : {name: 'Ho Chi Minh', type: 'folder'},
...
//}
//tree_data['hcm']['additionalParameters'] = {
//	'children' : {
...
//	}
//}
//tree_data['hcm']['additionalParameters']['children']['drinks']['additionalParameters'] = {
//	'children' : {
//		'hot' : {name: 'Hot Drinks', type: 'item'},
//		'cold' : {name: 'Cold Drinks', type: 'folder'}
//	}
//}
//tree_data['hcm']['additionalParameters']['children']['drinks']['additionalParameters']['children']['cold']['additionalParameters'] = {
//	'children' : {
...
var tree_data_3 = {
	'hcm' : {name: '<a href="organization.html"><i class="fa"></i> Ho Chi Minh</a>', type: 'folder'},
	'employees' : {name: 'Employees', type: 'folder'},
	'departments' : {name: 'Departments', type: 'item'},
	'benefits' : {name: 'Benefits', type: 'item'}
}
tree_data_3['hcm']['additionalParameters'] = {
	'children' : {
		'company-sales' : {name: '<a href="meter.html"><i class="fa"></i> Meter Info</a>', type: 'item'},
		'employee-sales' : {name: 'Employee Sales', type: 'folder'},
...
tree_data_3['hcm']['additionalParameters']['children']['employee-sales']['additionalParameters'] = {
		'children' : {
			'a' : {name: 'a', type: 'folder'}
		}
}
tree_data_3['hcm']['additionalParameters']['children']['employee-sales']['additionalParameters']['children']['a']['additionalParameters'] = {
		'children' : {
			'b' : {name: 'b', type: 'folder'}
		}
}
tree_data_3['hcm']['additionalParameters']['children']['employee-sales']['additionalParameters']['children']['a']['additionalParameters']['children']['b']['additionalParameters'] = {
		'children' : {
...
//console.log("Hello: " + JSON.stringify(tree_data_3));

var treeDataSource = new DataSourceTree({data: tree_data_3});